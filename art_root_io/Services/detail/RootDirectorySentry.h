#ifndef art_root_io_Services_detail_RootDirectorySentry_h
#define art_root_io_Services_detail_RootDirectorySentry_h
...
#endif /* art_root_io_Services_detail_RootDirectorySentry_h */
